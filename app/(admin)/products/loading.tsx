  ...
  return (
    <div className="w-full px-4 py-8 sm:px-8 sm:py-10">
      <header className="mb-8">
        <div className="h-8 w-36 animate-pulse rounded-md bg-border/70" />
        <div className="mt-2 h-4 w-24 animate-pulse rounded-md bg-border/50" />
      </header>

      <div className="mb-4 flex justify-end">
        <div className="h-10 w-32 animate-pulse rounded-lg bg-border/70" />
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-border bg-surface">
        ...
        <div className="divide-y divide-border">
          {Array.from({ length: 5 }).map((_, index) => (
            ...
            >
              <div className="size-14 shrink-0 animate-pulse rounded-md bg-border/60" />
              ...
              <div className="hidden gap-1.5 sm:flex">
                <div className="size-9 animate-pulse rounded bg-border/50" />
                <div className="size-9 animate-pulse rounded bg-border/50" />
              </div>
              <div className="h-8 w-16 animate-pulse rounded-md bg-border/50" />
            </div>
          ))}
        </div>
      </div>
